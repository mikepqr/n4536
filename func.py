...
class FuncOps(object):
    ...
    def __add__(self, f):
	return BinCompose(N.add, self, f)
   
    def __sub__(self, f):
	return BinCompose(N.subtract, self, f)
   
    def __mul__(self, f):
	return BinCompose(N.multiply, self, f)
   
    def __div__(self, f):
	return BinCompose(N.divide, self, f)
   
    def __neg__(self):
	return UnCompose(N.negative, self)

    def __pow__(self, f):
	return BinCompose(N.power, self, f)
    ...
    def exp(self):
	return UnCompose(N.exp, self)
   
    def log(self):
	return UnCompose(N.log, self)
